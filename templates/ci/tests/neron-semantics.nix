...
in
{
  ...
  specificity = {
    ...
    test-local-shadows-import = {
      ...
      in engine.query { dataFilter = n: n.decls.x or null; } result "consumer";
      expected = "local";
    };
    ...
    test-import-shadows-parent = {
      expr = let
        ...
        attributes = withImports {};
        result = engine.eval { inherit roots attributes; };
      in engine.query { dataFilter = n: n.decls.x or null; } result "child";
      expected = "imported";
    };
  ...
  wf-policy = {
    ...
    test-import-cycle-terminates = {
      expr = let
        ...
        attributes = withImports {};
        result = engine.eval { inherit roots attributes; };
      in engine.query { dataFilter = n: n.decls.y or null; } result "a";
      expected = "from-b";
    };
    ...
    test-wf-import-does-not-inherit-from-imported-parent = {
      expr = let
        roots = mkRoots {
          ...
          decls = {
            consumer = {};
            provider = {};
            provider-parent = { secret = "should-not-see"; };
          };
        };
        attributes = withImports {};
        result = engine.eval { inherit roots attributes; };
      ...
      in engine.query { dataFilter = n: n.decls.secret or null; } result "consumer";
      expected = null;
    };
  };
  ...
  ambiguity = {
    ...
    test-ambiguous-two-providers = {
      expr = let
        ...
        attributes = withImports {};
        result = engine.eval { inherit roots attributes; };
      in engine.ambiguous { dataFilter = n: n.decls.x or null; } result "consumer";
      expected = true;
    };
  ...
  custom-edges = {
    ...
    test-follow-custom-edge = {
      expr = let
        ...
        result = engine.eval { inherit roots attributes; };
      in engine.followEdge "R" result "record";
      expected = [ "extension" ];
    };
    ...
    test-collect-by-label = {
      ...
      in builtins.sort builtins.lessThan (
        engine.collectByLabel "R" (self: id: let f = (self.node id).decls.field or null; in if f != null then [f] else []) result "base"
      );
      expected = [ "a" "b" ];
    };
  ...
  subtype = {
    ...
    test-subtype-subset = {
      expr = let
        ...
        attributes = { imports = _self: _id: []; children = _self: _id: {}; };
        result = engine.eval { inherit roots attributes; };
      in engine.subtypeOf {} result "partial" "full";
      expected = true;
    };
    ...
    test-not-subtype-extra-field = {
      expr = let
        ...
        attributes = { imports = _self: _id: []; children = _self: _id: {}; };
        result = engine.eval { inherit roots attributes; };
      in engine.subtypeOf {} result "extra" "base";
      expected = false;
    };
    ...
    test-subtype-custom-eq = {
      ...
      in engine.subtypeOf { eq = _k: _a: _b: true; } result "a" "b";
      expected = true;
    };
    ...
    test-empty-subtypes-all = {
      expr = let
        ...
        attributes = { imports = _self: _id: []; children = _self: _id: {}; };
        result = engine.eval { inherit roots attributes; };
      in engine.subtypeOf {} result "empty" "full";
      expected = true;
    };
  };
  ...
  relations = {
    ...
    test-scoped-relations-via-attributes = {
      expr = let
        roots = mkRoots {
          decls = {
            module-a = { __relations = { types = { Int = "int"; }; values = { x = 1; }; }; };
          };
        };
        attributes = {
          imports = _self: _id: [];
    ...
    test-relations-inherited = {
      expr = let
        roots = mkRoots {
          ...
          decls = {
            outer = { __relations = { types = { Int = "int"; Bool = "bool"; }; }; };
            inner = { __relations = { types = { String = "string"; }; }; };
          };
        };
        attributes = {
          imports = _self: _id: [];
          ...
          all-types = engine.inherit' {
            resolve = n: let t = n.decls.__relations.types or null; in t;
          };
        };
        result = engine.eval { inherit roots attributes; };
      in {
      ...
      expected = {
        inner-own = { String = "string"; };
        inner-inherited = { String = "string"; };
        outer-types = { Int = "int"; Bool = "bool"; };
      };
    };
  };
}
